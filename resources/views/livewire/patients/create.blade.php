                    ...
                    <div class="row mb-4 mb-4">
                        <div class="col col-md-6 px-4">
                            ...
                            <x-input id="first_name" class="block mt-1 w-full" type="text" name="first_name"
                                :value="old('first_name')" required autofocus autocomplete="first_name" wire:model="first_name" />
                        </div>
                        <div class="col col-md-6 px-4">
                    ...
                    <div class="row mb-4">
                        <div class="col col-md-6 px-4">
                            ...
                            <x-input id="birthdate" class="block mt-1 w-full" type="date" name="birthdate"
                                :value="old('birthdate')" required autocomplete="birthdate" onkeydown="return false" wire:model="birthdate" />
                        </div>
                        <div class="col col-md-6 px-4">
