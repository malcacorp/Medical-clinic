...
<div class="row">
    <div class="col-lg-7 offset-lg-3">
        ...
        @endif
        <form method="post" enctype="multipart/form-data" action="{{ route('paciente.patologia.store') }}">
            @csrf
            <input type="hidden" value="{{ $paciente }}" name="id_persona">
            <div class="col-sm-9">
                <p>Registro de Patologias Paciente</p>
                <div class="form-group">
                    <label for="id_patologia">Patologia</label>
                    <select class="form-control select" required name="id_patologia">
            ...
            <div class="col-sm-9">
                <div class="form-group">
                    ...
                    <div class="cal-icon">
                        <input required type="text" class="form-control datetimepicker" name="fecha_ini">
                    </div>
                </div>
            </div>
            <div class="col-sm-9">
            ...
            <div class="col-sm-9">
                <div class="form-group">
                    ...
                    <select  required class="form-control select" name="ocurrencia">
            ...
            <div class="col-sm-9">
                <div class="form-group">
                    ...
                    <select  required class="form-control select" name="desenlace">
                            <option value='NE'> No Especificado </option>
