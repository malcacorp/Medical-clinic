...
<div class="row">
    <div class="col-lg-7 offset-lg-3">
        ...
        @endif
        <form method="post" enctype="multipart/form-data" action="{{ route('paciente.alergia.store') }}">
            @csrf
            <input type="hidden" value="{{ $paciente }}" name="id_persona">
            <div class="col-sm-9">
                <p>Registro de Alergias a Medicamentos Paciente</p>
                <div class="form-group">
                    <label for="id_alergia">Alergia</label>
                    <select class="form-control select" name="id_alergia">
            ...
            <div class="m-t-20 text-center">
                <button class="btn btn-primary submit-btn">Guardar Alergia</button>
            </div>
        </form>
    </div>
</div>
