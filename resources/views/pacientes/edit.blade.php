...
<div class="row">
    <div class="col-lg-8 offset-lg-2">
        ...
        @endif
        <form method="post" enctype="multipart/form-data" action="{{ route('paciente.update',$paciente) }}">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-12">
                    <h4>Identidad del paciente </h4>
                </div>
                ...
                <div class="col-sm-8">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$paciente->dni}}" class="form-control" name="dni" onfocusout="ajax.buscar_cedula();">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="{{$paciente->login}}" name="login">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" value="{{$paciente->password}}" type="password" name="password">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <h6>Vista previa </h6>
                    <img alt="" style="width:100%;"  src="{{ asset('imagenes/'.$paciente->ruta_doc_identidad) }}">
            ...
            <div class="row mt-2">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input value="{{$paciente->nombres}}" class="form-control" type="text" name="nombres">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <label>Apellido Paterno</label>
                        <input class="form-control" type="text" value="{{$paciente->apellido_materno}}" name="apellido_materno">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="profile-upload">
                            <div class="upload-img">
                                <img alt="" src="{{ asset('imagenes/'.$paciente->ruta_foto) }}">
                            </div>
                            <div class="upload-input">
